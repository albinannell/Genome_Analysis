...
#SBATCH --output=/home/alan4480/genome_analysis/Genome_Analysis/analyses/05_RNA/02_trimming/01_trimming_RNA-Seq_BH_and_Serum/trimmomatic.%j.out
...
OUTPUT_DIR="/home/alan4480/genome_analysis/Genome_Analysis/analyses/05_RNA/02_trimming/01_trimming_RNA-Seq_BH_and_Serum"
ADAPTERS="/sw/apps/bioinfo/trimmomatic/0.39/rackham/adapters/TruSeq3-PE.fa"

# Input files
INPUT_FILES="$RAW_DIR/RNA-Seq_BH/trim_paired*"
